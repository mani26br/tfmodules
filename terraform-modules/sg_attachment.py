...
region = "us-east-1"
project_values = ["sandbox", "sandboxz"]  # Remaining arguments are treated as project values


# Initialize AWS session and resources
...
# Cache security group IDs per VPC
vpc_sg_map = {}

# Filter instances by the project tag values
filters = [
    {'Name': 'tag:project', 'Values': project_values}
]

# Retrieve instances matching the tag filter
...
for instance in filtered_instances:
    ...
    try:
        # Fetch or cache the security group ID for this VPC
