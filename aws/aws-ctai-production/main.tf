...
module "lambda_permission_compliance_report" {
  source = "../../terraform-modules/aws/lambda/lambda_permission"
  lambda_permission_function_name = var.lambda_function_compliance_report_name
  lambda_permission_source_arn = module.lambda_compliance_report_cloudwatch_event.cloudwatch_event_rule_arn
}

module "lambda_compliance_report_cloudwatch_event" {
  source = "../../terraform-modules/aws/platform-services/cloudwatch_event/schedule"
  cloudwatch_event_rule_name = "invoke-lambda-compliance-report-daily"
  cloudwatch_event_rule_description = "Invoke Lambda function daily"
  cloudwatch_event_target_arn = module.lambda_function_compliance_report.lambda_function_arn
}
...
module "lambda_permission_cost_report" {
  source = "../../terraform-modules/aws/lambda/lambda_permission"
  lambda_permission_function_name = var.lambda_function_cost_report_name
  lambda_permission_source_arn = module.lambda_cost_report_cloudwatch_event.cloudwatch_event_rule_arn
}

module "lambda_cost_report_cloudwatch_event" {
  source = "../../terraform-modules/aws/platform-services/cloudwatch_event/schedule"
  cloudwatch_event_rule_name = "invoke-lambda-cost-report-bi-weekly"
  cloudwatch_event_rule_description = "Invoke Lambda cost report function bi-weekly"
  cloudwatch_event_target_arn = module.lambda_function_cost_report.lambda_function_arn
  cloudwatch_event_rule_schedule_expression = "cron(0 11 15,30 * ? *)"
}
