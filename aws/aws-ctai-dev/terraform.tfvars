platform_service_default_group_name = "229110399928-mfa-users"
IAM_role_arn = "arn:aws:iam::229110399928:role/aws-ctaidev-jenkins-pipeline-role"
common_tags = {     
      "project"       = "ccos"
      "environment"   = "prod"
...
###Config###
aws_config_sqs_name = "aws-ctai-dev-config-queue"
config_existing_topic_name = "aws-controltower-AllConfigNotifications"

/*
##Guardduty###
guardduty_sns_topic_name = "aws-ctai-dev-guardduty-notifications"
guardduty_sqs_name = "aws-ctai-dev-guardduty-queue"
guardduty_logs_s3_bucket_name = "aws-ctai-dev-guardduty-s3-bucket"
guardduty_event_name = "aws-ctai-dev-guardduty-events"
guardduty_subscription_email = "NCATSCPE@mail.nih.gov"
*/

###VPC_flow_logs###
flowlogrole_name = "aws-ctai-dev-vpc-flow-log-role"
flowlogrole_policy_name = "aws-ctai-dev-vpc-flow-log-policy"

###DNS_query_logs###
#zone_id = ["Z1034841NXJX3LSKB8MO", "Z04153112MD4V0ZJR1AAR"]

###SGC_AWS_Systems_Manager###
aws_ssm_sgc_bucket_name = "aws-ctai-dev-snow-sgc-data"
...
###Compliance_Report###
compliance_report_bucket_name = "aws-ctai-dev-compliance-report-s3-bucket"
lambda_compliance_report_role_name = "aws-ctai-dev-compliance-report-role"
lambda_compliance_report_policy_name = "aws-ctai-dev-compliance-report-policy"
lambda_function_compliance_report_name = "aws-ctai-dev-compliance-report-function"
compliance_report_name = "aws-ctai-dev_required-tags_non-compliant_all-resources"

###Cost-Reports###
cost_report_bucket_name = "aws-ctai-dev-cost-report-s3-bucket"
lambda_cost_report_role_name = "aws-ctai-dev-cost-report-role"
lambda_cost_report_policy_name = "aws-ctai-dev-cost-report-policy"
lambda_function_cost_report_name = "aws-ctai-dev-cost-report-function"
cost_report_name = "aws-ctai-dev_cost_report_all-resources"
