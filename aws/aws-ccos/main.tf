...
#   depends_on = [module.aws_ssm_sgc_document]
#   association_name = "SGC"
#   name = "SG-AWS-RunShellScript"
#   key = "InstanceIds"
#   values = ["*"]
#   schedule_expression = "at(2023-09-26T20:25:00)"
#   s3_bucket_name = module.aws_ssm_sgc_s3_bucket.s3_bucket_name 
#   s3_key_prefix = "SGC/"
# }
